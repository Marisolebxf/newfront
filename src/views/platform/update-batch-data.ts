...
export type ProcessingStatus = '已完成' | '待人工处理' | '人工处理中' | '人工处理完成'
...
export const processingInstances: ProcessingInstance[] = [
  ...
  },
  {
    ...
    relationEvidence: '两端主题共同出现在论文关键词和两跳图谱路径中', rule: '两跳路径与主题共现规则', confidence: '0.72', result: '生成主题相近关系 e40', status: '已完成', processedAt: '2026-07-14 02:18:12',
  },
  {
  ...
  },
  {
    ...
    relationEvidence: '当前仅命中一条合作公告，未达到双来源证据要求', rule: '关系证据完整性规则', confidence: '0.74', result: '候选关系已隔离', status: '人工处理中', processedAt: '2026-07-14 02:23:18', reviewType: '关系证据不足',
  },
  {
  ...
  },
  {
    ...
    sourceTable: '论文成果表', sourceRecordId: 'P202607130104', rule: '论文必填完整性规则', confidence: '0.91', result: '标题缺失，等待人工补全', status: '人工处理中', processedAt: '2026-07-14 02:26:04', reviewType: '必填缺失',
  },
  {
