...
SCHEMA_DDL: list[str] = [
    ...
    # 论文合作关系
    "CREATE EDGE IF NOT EXISTS CO_AUTHORED("
    "paper_count int64, first_year int64, last_year int64, "
    "cooperation_frequency int64, academic_impact_score double, "
    "topics string, source string);",
    "CREATE EDGE INDEX IF NOT EXISTS co_authored_idx ON CO_AUTHORED();",
    # 专家直接关系
    "CREATE EDGE IF NOT EXISTS DIRECT_RELATION("
    "relation_subtype string, reasons string, "
    "relation_strength int64, institution string, "
    "directions string, source string);",
    "CREATE EDGE INDEX IF NOT EXISTS direct_relation_idx ON DIRECT_RELATION();",
]
